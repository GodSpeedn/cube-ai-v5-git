...
# Simple GitHub integration - no complex imports
GIT_AVAILABLE = False
...
class FileManager:
    ...
    def __init__(self, base_dir: str = "generated"):
        ...
        # Simple file management - no GitHub integration for now
        self.github_available = False
        logging.info("📁 File manager initialized for local file saving only")
